...
> Mote: You can modify default values for `options` inside Creep.prototype.moveTo. If you want them to be applied to all `moveTo` calls. But still remain possiility to be overrided if passed explicitely to `moveTo`.
